package com.baymax.camerax.example;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void showCameraWithPermissionCheck() {
        startCamera();
    }
    ...
    void capture() {
        shootSound();
        final File file = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), "MYCASHLESS_PHOTO.jpg");
